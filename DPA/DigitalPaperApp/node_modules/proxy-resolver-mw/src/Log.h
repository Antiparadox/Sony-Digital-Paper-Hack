...
#define LOG_DEBUG	Log(_T("reg-store-mw:crypto_utils:debug"), _T("[DEBUG]"), __FUNCTION__, _T(__FILE__), (__LINE__))
#define LOG_ERROR	Log(_T("reg-store-mw:crypto_utils:error"), _T("[ERROR]"), __FUNCTION__, _T(__FILE__), (__LINE__))
#define LOG			Log(_T("reg-store-mw:crypto_utils"), _T(""), __FUNCTION__, _T(__FILE__), (__LINE__))
