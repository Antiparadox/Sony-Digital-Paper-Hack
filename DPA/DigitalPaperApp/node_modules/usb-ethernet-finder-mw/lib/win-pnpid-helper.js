...
const log_error = require('debug')('usb-ethernet-finder-mw:win-pnpid-helper:error');
const log_debug = require('debug')('usb-ethernet-finder-mw:win-pnpid-helper:debug');
...
class WinPnpIdHelper {
   ...
   * @return  {object} vid, pid   - Vendor ID および Product ID。エラー時にはnull。
   */
