...
class FindUsbDeviceWorker : public Nan::AsyncWorker
{
private:
    int idVendor;
    int idProduct;
...
public:
     ...
     * Constructor
     */
	FindUsbDeviceWorker(int idVendor, int idProduct, Nan::Callback* callback)
    ...
    virtual void Execute()
    {
		...
		const std::string result = UsbDeviceFinder::FindUsbDevices(idVendor, idProduct, deviceList);
		if (!result.empty()) {
