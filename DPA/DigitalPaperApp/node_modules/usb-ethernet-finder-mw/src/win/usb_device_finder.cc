...
#include "FindUsbDeviceWorker.h"

/**
 * Windowsに接続されているUSB機器を検索する。
 *
...
NAN_METHOD(find)
{
    ...
    Nan::AsyncQueueWorker(new FindUsbDeviceWorker(idVendor, idProduct, callback));
}
...
NODE_MODULE(usb_device_finder, init);
